...
def connect_to(hostname_or_ip, servname_or_port):
    print("connect_to('{}', '{}')".format(hostname_or_ip, servname_or_port))
    try:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', type=str, default='www.google.com', help='hostname that you want to contact')
