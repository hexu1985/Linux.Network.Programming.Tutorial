...
void client(const char *host, uint16_t port)
{
    ...
    PutBlock(sockfd, "Beautiful is better than ugly.");
    PutBlock(sockfd, "Explicit is better than implicit.");
    PutBlock(sockfd, "Simple is better than complex.");
    PutBlock(sockfd, "");
...
void print_usage(const char *prog) 
{
    ...
    puts("");
    puts("Transmit & receive blocks over TCP");
    puts("");
